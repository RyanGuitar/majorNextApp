...
const MajorMemory = (props) => {
  ...
  const [copyFilterGroup, setCopyFilterGroup] = useState(
    shuffle([...filteredGroup])
  );
  ...
  return (
    <>
      <Head>
        <title>Major Memory Trainer | Major Memory</title>
      </Head>
      <div id="GameContainer">
        <div id="GameHeader">
          <div>
            <span>{copyFilterGroup[count].num}</span>
            <Link href={"Menu"}>
              <span id="GameX">X</span>
            </Link>
          </div>
        </div>

        <div id="GameImages">
          <div className="hide" id="GameMessage">
            <div>Wrong</div>
          </div>
        ...
        <div id="GameButtonBox">
          ...
          <button onClick={() => navigate("next")} id="GameNext">
            Next
          </button>
        </div>
      </div>
